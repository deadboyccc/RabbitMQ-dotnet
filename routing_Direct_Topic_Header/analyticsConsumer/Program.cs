...
internal class RabbitMQConsumer
{
  public static async Task Main(string[] args)
  {
    ...
    //binding the channel 
    await channel.Result.QueueBindAsync(queueName, exchange: "Directrouting", routingKey: "analytics");
    ...
    consumer.ReceivedAsync += async (model, msg) =>
    {
      ...
      Console.WriteLine($" [Analytics] Received {message} | Took {processingTime}s to recieve");
    ...
    Console.WriteLine(" [Analytics] Waiting for messages. Press [enter] to exit.");
